            ...
            >
              ...
              >
                <Badge className="mb-6 px-6 py-2 text-sm bg-white/20 text-white border-white/30 backdrop-blur-sm hover:bg-white/30 transition-colors">
                  ...
                  Powered by Rareus Private Limited
                </Badge>
              </motion.div>
              ...
              >
                <span className="text-white block mb-4 drop-shadow-2xl">Transform Scrap</span>
              ...
              >
                India's most trusted B2B scrap marketplace. Connecting verified buyers with sellers.
